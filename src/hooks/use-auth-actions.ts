import { signInWithEmailAndPassword, createUserWithEmailAndPassword, type AuthError, updateProfile, GoogleAuthProvider, signInWithPopup, signOut } from "firebase/auth";
